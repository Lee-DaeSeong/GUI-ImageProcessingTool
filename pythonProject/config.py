...
model_config.add_argument('--P_IDP', type=eval, default=6.5, help='')
model_config.add_argument('--f', type=eval, default=550, help='')
model_config.add_argument('--P_c_x', type=eval, default=0, help='')
model_config.add_argument('--P_c_y', type=eval, default=-20, help='')
model_config.add_argument('--P_c_z', type=eval, default=0, help='')
model_config.add_argument('--S_W', type=eval, default=37, help='')
model_config.add_argument('--S_H', type=eval, default=17, help='')
